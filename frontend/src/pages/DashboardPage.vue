        ...
        <div class="brand">
          ...
          <div class="brand-titles">
            <div class="brand-row">
              ...
              <Tag severity="success" class="pill pill-route">/dashboard</Tag>
            </div>

            <div class="brand-sub muted">
              Visão geral da coleção · <span v-if="firstDay && lastDay">{{ firstDay }} → {{ lastDay }}</span>
...
.app-shell {
  ...
  background:
    ...
    linear-gradient(180deg, rgba(10, 10, 12, 0), rgba(10, 10, 12, 0.35));
}

/* ✅ Usa a tela toda (sem "centralizar" com max-width) */
.main {
  flex: 1;
  min-height: 0;
  padding: 14px;
