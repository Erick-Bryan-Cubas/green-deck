...
SUPERMEMO_RULES = """Effective learning: Twenty rules of formulating knowledge
...
Creating cloze deletions in new SuperMemos:select the keyword that is to be replaced with tree dots and press Alt+Z	Generating a cloze deletions from texts placed in the clipboard in SuperMemo 2000:
...
Reading : Remember cloze (or click one of cloze icons on the reading toolbar) 	Cloze deletions in SuperMemo 98/99:
1. Press Ctrl+A to add a standard question-and-answer item
2. Paste the text into the question field. This will create the outline of your items
3. Press Ctrl+Alt+U to Duplicate the element
4. Select the part that is to be replaced with three dots
5. Cut the selection to the clipboard (e.g. with Shift+Del)
6. Type in three dots (optionally, add the explanation in parentheses as in above examples)
7. Press Ctrl+T to save the question field and move to the answer field
8. Paste the text cut in Step 5 (e.g. with Shift+Ins or Ctrl+V). Your first item is ready
9. Press PgUp to go back to the outline item created in Step 2
...
1. Press Shift+Ins to paste the picture to SuperMemo

2. Press Ctrl+Shift+M and choose Occlusion template to apply graphic deletion template

3. SuperMemo 2000 only: Choose Ctrl+Shift+F2 to impose and detach the Occlusion template

4. Fill out the fields and place the occlusion rectangle to cover the appropriate part of the picture (use Alt+click twice to set the rectangle in the dragging mode)	In SuperMemo 99 you will need a few more steps:
